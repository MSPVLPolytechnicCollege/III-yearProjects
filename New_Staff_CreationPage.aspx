<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="New_Staff_CreationPage.aspx.cs" Inherits="AUTOMATED_ATTADANCE_SYSTEM.New_Staff_CreationPage" %>
...
<head>
    ...
    <title>New Staff Creation Page</title>
    <style>
        /* Basic styles */
        body {
...
<body>
    ...
    <div class="container">
        <!-- Page Title -->
        <h1>New Staff Creation Page</h1>

        <!-- Staff ID -->
        <div class="form-group">
            <label for="Staff_id">Staff ID</label>
            <input type="text" id="Staff_id" runat="server" placeholder="Enter Staff ID" />
        </div>

        <!-- Staff Name -->
        <div class="form-group">
            <label for="Staff_Name">Staff Name</label>
            <input type="text" id="Staff_Name" runat="server" placeholder="Enter Staff Name" />
        </div>
